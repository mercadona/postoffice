defmodule Postoffice.PromEx do
  @moduledoc """
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: PostofficeWeb.Router},
      Plugins.Ecto,
      Plugins.Oban

      # Add your own PromEx metrics plugins
      # Postoffice.Users.PromExPlugin
    ]
  end
  ...
  #     # {:postoffice, "/grafana_dashboards/user_metrics.json"}
  #   ]
  # end
end
